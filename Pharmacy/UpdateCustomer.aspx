<%@ Page Title="" Language="C#" MasterPageFile="~/pharm.Master" AutoEventWireup="true" CodeBehind="UpdateCustomer.aspx.cs" Inherits="Pharmacy.WebForm9" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="border-bottom-color:purple;font-size:large;padding:5px 5px 5px 5px"><p></p>Edit Customers</div><p></p>
        ...
        <asp:TextBox runat="server" ID="EditCustomerName" CssClass="form-control"></asp:TextBox>

         <asp:Label runat="server" Text="Customer Phone: "></asp:Label>
        <asp:TextBox runat="server" ID="EditCustomerPhone" CssClass="form-control"></asp:TextBox>

         <asp:Label runat="server" Text="Customer Address: "></asp:Label>
        <asp:TextBox runat="server" ID="EditCustomerAddress" CssClass="form-control"></asp:TextBox>
        <p></p>
