<%@ Page Title="" Language="C#" MasterPageFile="~/pharm.Master" AutoEventWireup="true" CodeBehind="ViewPurchase.aspx.cs" Inherits="Pharmacy.WebForm22" %>
    ...
    <div class=" container-fluid row rounded" style="border: thin solid #33CC33; margin-bottom:30px; padding: 10px;">
            <div class="col-md-4">
                   <i class="fa fa-suitcase"></i> <asp:Label runat="server" Text="Supplier Name "></asp:Label>
                    <asp:DropDownList Enabled="false" runat="server" ID="SupplierDDL" CssClass="form-control" DataSourceID="SupplierNameDS" DataTextField="Name" DataValueField="Name"></asp:DropDownList>
               ...
               <i class="fa fa-plus"> </i><asp:Label runat="server" TEXT="Medicine Name "></asp:Label>
                <asp:DropDownList runat="server"  ID="MedicineNameDDL" Enabled="false" CssClass="form-control" DataSourceID="MedicineNameDS" DataTextField="Name" DataValueField="Name">           
                </asp:DropDownList><br />
                ...
                <div class="form-row">
                <span class=" col">
     <i class="fa fa-list"></i> <asp:Label runat="server" Enabled="false" Text="Quantity"></asp:Label>
                <asp:TextBox runat="server" ID="QuantityTextBox" Enabled="false" AutoPostBack="true" CssClass="form-control"></asp:TextBox></span>
              <span class="col"> <i class="fa fa-dollar"></i> <asp:Label runat="server"  Text="Price"></asp:Label>
              <asp:TextBox runat="server" ID="PurchasePriceTextBox" Enabled="false" AutoPostBack="true" CssClass="form-control"></asp:TextBox>
                </span>
               ...
               <p>          <span class="text-right text-secondary" style="font-size:smaller">Press Enter to calculate values </span>
                ...
                <div class="text-center">
                    <asp:LinkButton runat="server" Enabled="false" ID="AddPurchase1" CssClass="btn btn-primary">Add To List</asp:LinkButton>
                </div> </div>
            ...
            <div class="col-lg-8">
                <div style="align-content:center">
                  <i class="fa fa-calendar"></i> <asp:Label runat="server" ID="DateLbl" Text="Date Of Purchase"></asp:Label>
                    <asp:TextBox runat="server" CssClass="form-control" Enabled="false" Width="150px" ID="DateTextBox"></asp:TextBox>
                </div><p></p>
           <div class="card">
               <div class="card-header text-white" style="background-color:purple;font-size:large">Product List</div>
               <div class="card-body" style="width:300px">
                  <asp:GridView OnRowDeleting="DetailsGridView_RowDeleting" OnRowDataBound="DetailsGridView_RowDataBound" EmptyDataText="No Enlisted product....!!!" EmptyDataRowStyle-Font-Italic="true" DataKeyNames="SupplierName" ShowHeaderWhenEmpty="True"  runat="server" ID="DetailsGridView" AutoGenerateColumns="False" BackColor="White" BorderColor="Gray" BorderStyle="None" CellPadding="5" GridLines="Horizontal" Width="600px" ForeColor="Gray">
                      <Columns>                   
                           ...
                           <asp:TemplateField>
                               <ItemTemplate>
                                  <asp:LinkButton runat="server" ToolTip="Delete" ID="DeleteBtn" Enabled="false" CommandName="Delete" CssClass="btn btn-toolbar fa fa-trash text-danger"></asp:LinkButton>
                              </ItemTemplate>
                          </asp:TemplateField>
                      </Columns>
              ...
              <SortedDescendingHeaderStyle BackColor="#15524A" />
               ...
               <div class="card-footer text-right text-white" style="font-weight:bold;font-size:medium;background-color:purple"> Total:
                ...
                <p></p>
                 <span class="col">
                           <asp:CheckBox runat="server" Enabled="false" AutoPostBack="true" ID="DiscountCheckBox" Text=" Discount%"></asp:CheckBox><br />
                      <asp:Label runat="server" Text="Discount"></asp:Label>                 
                <asp:TextBox runat="server" Enabled="false" CssClass="form-control"  AutoPostBack="true"  ID="DiscountTextBox"></asp:TextBox>
                     </span> 
                 <div class="form-row">
                    <div class="col">              
                         <asp:Label runat="server" CssClass="text-center" Text="Total" ID="GrandTotalLbl"></asp:Label>
                    <asp:TextBox runat="server" CssClass="form-control" Enabled="false" AutoPostBack="true" Font-Bold="true" ID="TotalResultTxtBox" ReadOnly="true"></asp:TextBox>
                   <p></p>
         
              <div>
                   <i class="fa fa-paypal"></i> <asp:Label runat="server"  Text="Payment Method: "></asp:Label><br />
                    <asp:DropDownList runat="server" Enabled="false" ID="MethodDDL" CssClass="form-control">
              ...
              <div>
                    ...
                    <asp:DropDownList runat="server" Enabled="false" ID="StatusDDL" CssClass="form-control">
                        ...
                        <asp:Button runat="server" ID="cancelbtn" Text=" Return to Purchase" PostBackUrl="~/Purchases.aspx" CssClass="btn btn-info text-white" />
            </div>
