<%@ Page Title="" Language="C#" MasterPageFile="~/pharm.Master" AutoEventWireup="true" CodeBehind="Sales-Report.aspx.cs" Inherits="Pharmacy.WebForm20" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            <div style="font-weight: bold;font-size: 20px;margin: 10px 10px; border-bottom-style: solid; border-bottom-color: #33CC33;">Sales Report</div>
   <div class="row" style="font-weight:bold">
       <div class="col-md-3">
           <asp:Label ID="purchaseReportLabel" Text="From" runat="server"></asp:Label>
           <asp:TextBox ID="PurchaseDateTextbox" CssClass="form-control" Placeholder="Date" runat="server"></asp:TextBox>
       </div>
